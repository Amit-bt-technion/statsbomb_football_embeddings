"""
Tokenizer configuration module.

This module contains all configuration constants, mappings, and parser definitions
used by the tokenizer package.
"""
import logging
...
event_types_mapping = {
    ...
    23: {
        ...
        "feature_parsers": {
            ...
            "goalkeeper.end_location[0]": RangeFeatureParser("x_location", min_value=0, max_value=120),
            "goalkeeper.end_location[1]": RangeFeatureParser("y_location", min_value=0, max_value=80),
        }
    },
    # bad behavior event
    24: {
